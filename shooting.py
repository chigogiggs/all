...
hrt = pygame.image.load('hrt.jpg')
hrt = pygame.transform.scale(hrt, (20, 20))
...
class Warrior:
    ...
    def lifecount(self):
        ...
        pygame.draw.rect(screen, (255,255,255),(350+220,textpos[1]+5,220,20))
        # print(textpos[1])
        screen.blit(text, (textpos[0]+185,textpos[1]+5))
        pygame.draw.rect(screen, (0,255,0),(350+240,textpos[1]+10,200,10))
        pygame.draw.rect(screen,lifecolor,(350+240,textpos[1]+10,liferaduis,10))
    def scores(self):
